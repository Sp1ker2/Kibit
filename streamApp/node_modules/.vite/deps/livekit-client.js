  ...
  handleConnectionError(reason, validateUrl) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        return e2 instanceof ConnectionError ? e2 : new ConnectionError(e2 instanceof Error ? e2.message : "server was not reachable", ConnectionErrorReason.ServerUnreachable);
      }
    });
  }
};
